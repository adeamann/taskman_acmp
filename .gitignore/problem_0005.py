...
for i in range(len(lst)):
  if lst[i] % 2 == 0:         # проверка элемента начетность с последующим добавлением элементов
    even.append(lst[i])       # в список even и not_even
  else:
    not_even.append(lst[i])
print(*not_even)
print(*even)
if len(not_even) > len(even): # вывод результатов
  print("NO")
else:
  print("YES")
